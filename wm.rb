...
module Wmii
  ...
  # perform operations on all of them simultaneously.
    ...
    # there are no grouped clients, then the currently focused client is
  ...
  # abstraction of WM components
    ...
    class Area
      ...
      # array abstraction: area is an array of clients
        ...
        # Inserts the given clients after the currently focused client in this
        # area.
        def insert *aClients
          aClients.flatten!
    ...
    class View < FsNode
      ...
      # WM hierarchy
        ...
        # Resiliently iterates through possibly destructive changes to each
        # column. That is, if the given block creates new columns, then those
        # will also be processed in the iteration.
      ...
      # visual arrangement of clients
        ...
        # Arranges the clients in this view, while maintaining their relative
        # order, in the tiling fashion of LarsWM. Only the first client in the
        # primary column is kept; all others are evicted to the *top* of the
        # secondary column. Any subsequent columns are squeezed into the
        ...
        # Arranges the clients in this view, while maintaining their relative
        # order, in a (at best) square grid.
        ...
        # Arranges the clients in this view, while maintaining their relative
        # order, in a (at best) equilateral triangle. However, the resulting
        # arrangement appears like a diamond because wmii does not waste screen
        # space.
